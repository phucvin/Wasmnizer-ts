(module
 ...
 (type $36 (func (param anyref) (result anyref)))
 (type $94 (func (result anyref)))
 (type $95 (func (param anyref f64) (result anyref)))
 (type $41 (func (param anyref anyref) (result anyref)))
 (type $42 (func (param anyref anyref) (result stringref)))
 ...
 (import "libdyntype" "dyntype_new_string" (func $dyntype_new_string (type $41) (param anyref anyref) (result anyref)))
 (import "libdyntype" "dyntype_toString" (func $dyntype_toString (type $42) (param anyref anyref) (result stringref)))
 ...
 (func $test/fib03|fib (type $36) (; has Stack IR ;) (param $0 anyref) (result anyref)
  (local $1 anyref)
  (if (result anyref)
   (f64.lt
 ...
 (func $fib-wrapper (type $36) (; has Stack IR ;) (param $0 anyref) (result anyref)
