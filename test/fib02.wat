(module
 ...
 (type $95 (func (result anyref)))
 (type $96 (func (param anyref f64) (result anyref)))
 ...
 (import "libdyntype" "dyntype_get_context" (func $dyntype_get_context (type $95) (result anyref)))
 (import "libdyntype" "dyntype_new_number" (func $dyntype_new_number (type $96) (param anyref f64) (result anyref)))
 ...
 (func $find_property_flag_and_index (type $66) (; has Stack IR ;) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $test/fib02|fib (type $65) (; has Stack IR ;) (param $0 i32) (result i32)
  (if (result i32)
   (i32.ge_s
    (local.get $0)
    (i32.const 2)
 ...
 (func $fib-wrapper (type $65) (; has Stack IR ;) (param $0 i32) (result i32)
